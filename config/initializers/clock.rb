...
require File.expand_path('../../../lib/classes/EvernoteUtils.rb',__FILE__)

module Clockwork
  Clockwork::handler do |job|
    EvernoteClass.update
  end
  # every(15.minutes, 'puts', :thread => true)
  every(15.minutes, 'puts')
end

class EvernoteClass < ApplicationController
  def self.update
